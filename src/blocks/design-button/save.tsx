...
import type { DesignButtonSaveProps } from "./types";

export default function save({ attributes }: DesignButtonSaveProps) {
	const {
		buttonType,
		linkKind,
		modalClassName,
	...
	return (
		<div {...blockProps}>
			<div className="itmar-wrap">{toolTipContent}</div>
		</div>
	);
}
